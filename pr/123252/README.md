...
- **Branch:** `pr123252-fix` (also on integration branch `openacc`)
...
- `pr123252-scalar-field-mapping.patch`
...
PASS: gfortran.dg/goacc/pr123252.f90   -O   scan-tree-dump omplower "map\(delete:c\.flag"
PASS: gfortran.dg/goacc/pr123252.f90   -O   scan-tree-dump omplower "map\(delete:c\.n"
```
